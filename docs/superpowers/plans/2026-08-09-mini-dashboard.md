...
**Interfaces:**
- Consumes: the dataclasses from Tasks 3–5. **Not `Config`** — the fetchers already bake display-ready units and place names into their dataclasses, so the renderer never needs it.
- Produces:
