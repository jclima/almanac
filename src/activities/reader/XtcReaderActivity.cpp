...
XtcReaderActivity::StatusBarInfo XtcReaderActivity::getStatusBarInfo() const {
  ...
  std::string title = sb.titleMode == AlmanacSettings::STATUS_BAR_TITLE::BOOK_TITLE ? xtc->getTitle() : "";
  ...
  if (sb.titleMode == AlmanacSettings::STATUS_BAR_TITLE::CHAPTER_TITLE) {
...
void XtcReaderActivity::renderStatusBarOverlay(const StatusBarOverlayPosition position) const {
  const auto sb = SETTINGS.statusBarSpec();
  const bool drawBottom = sb.xtcMode == AlmanacSettings::XTC_STATUS_BAR_MODE::XTC_STATUS_BAR_BOTTOM &&
                          position == StatusBarOverlayPosition::Bottom;
  const bool drawTop = sb.xtcMode == AlmanacSettings::XTC_STATUS_BAR_MODE::XTC_STATUS_BAR_TOP &&
...
void XtcReaderActivity::renderPage() {
  ...
  if (SETTINGS.statusBarSpec().xtcMode == AlmanacSettings::XTC_STATUS_BAR_MODE::XTC_STATUS_BAR_TOP) {
