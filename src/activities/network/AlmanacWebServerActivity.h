...
#include "network/AlmanacWebServer.h"
...
/**
 * AlmanacWebServerActivity is the entry point for file transfer functionality.
 * It:
 ...
 * - Starts the AlmanacWebServer when connected
 * - Handles client requests in its loop() function
 * - Cleans up the server and shuts down WiFi on exit
 */
class AlmanacWebServerActivity final : public Activity {
  ...
  std::unique_ptr<AlmanacWebServer> webServer;
 ...
 public:
  explicit AlmanacWebServerActivity(GfxRenderer& renderer, MappedInputManager& mappedInput)
      : Activity("AlmanacWebServer", renderer, mappedInput) {}
