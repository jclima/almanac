...
- **Customization**: the Almanac instrument-panel theme, sleep screen modes, front/side button remapping, status bar controls, power-button behavior, refresh cadence, and more.
